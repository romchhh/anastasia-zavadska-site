...
export const SERVICES = [
  {
    ...
    priceLine: "Вартість:",
    priceEmphasis: "$50",
    price: "Тривалість: 50 хвилин. Вартість: $50 USD",
    btnLabel: "Записатися",
    active: true,
  ...
  },
  {
    ...
    /** Короткий текст на картці в блоці «Послуги» на головній */
    descCard:
      "Невелика група 6–8 людей, де можна побачити себе через взаємодію з іншими.",
    extra: "Формат: раз на тиждень | 3 години",
    priceLine: "Вартість:",
    priceEmphasis: "$20 / зустріч",
    price: "Вартість: $20 USD / зустріч",
  ...
  },
  {
    ...
    descCard:
      "Офлайн-зустрічі для глибшого занурення в себе – у форматі живого спілкування, практик та внутрішньої роботи у групі.",
